...
const images: CustomImage = {
  ...
  cometx: { src: './cometx.png', width: '317px', height: '185px' },
  ...
  marvelSearchEngine: { src: './marvel-search-engine.png', width: '317px', height: '185px' },
  microsoft: { src: './Microsoft.png', width: '100px', height: '100px', enableMobileDimensions: true },
  organicShop: { src: './organic-shop.png', width: '317px', height: '185px' },
  tictactoe: { src: './tictactoe.png', width: '317px', height: '185px' },
  ...
  weatherapp: { src: './weather-app.png', width: '317px', height: '185px' }
}
